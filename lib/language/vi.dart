const Map<String, String> vi = {
  ...
  "connect_anywhere": "Kết nối mọi lúc, mọi nơi\nTrò chuyện nhanh chóng và chính xác",
  "account_settings": "Cài đặt tài khoản",
  "messages_security": "Bảo mật tin nhắn",
  "support_help": "Hỗ trợ & Trợ giúp",
  "account_management": "Quản lý tài khoản",
  "manage_pending_requests": "Quản lý yêu cầu đang chờ",
  "discover_connection_power": "Khám phá sức mạnh kết nối",
  "messages": "Tin nhắn",
  "unlimited": "Không giới hạn",
  "send_messages_images_videos_files": "Gửi tin nhắn, hình ảnh, video, tệp tin",
  "completely_free_unlimited": "Hoàn toàn miễn phí và không giới hạn",
  "calls": "Cuộc gọi",
