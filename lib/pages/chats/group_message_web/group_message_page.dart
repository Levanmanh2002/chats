...
import 'package:chats/pages/chats/group_message_web/view/group_bottom_send_mess_view.dart';
import 'package:chats/pages/chats/group_message_web/view/group_chast_list_view.dart';
import 'package:chats/pages/chats/group_message_web/view/group_quick_message_view.dart';
import 'package:chats/pages/chats/group_message_web/view/group_reply_message_view.dart';
import 'package:chats/pages/chats/group_message_web/view/group_selected_images_list.dart';
import 'package:chats/pages/chats/group_message_web/view/group_tickers_view.dart';
    ...
    return Obx(
      () => Scaffold(
        ...
        appBar: SearchAppbar(
          ...
          onSubmitted: (String value) => controller.onSearchMessage(value, isGroup: true),
        ...
        body: Column(
          children: [
            ...
            Obx(() => (controller.messageReply.value != null) ? GroupReplyMessageWebView() : const SizedBox()),
            GroupSelectedImagesListWebView(),
            Obx(() => (controller.quickMessage.value != null) ? GroupQuickMessageWebView() : const SizedBox()),
            GroupBottomSendMessWebView(),
            Obx(() => controller.isTickers.isTrue ? GroupTickersWebView() : const SizedBox()),
          ],
        ),
      ),
    );
