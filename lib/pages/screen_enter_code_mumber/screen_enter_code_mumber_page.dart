...
class ScreenEnterCodeMumberPage extends GetWidget<ScreenEnterCodeMumberController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: appTheme.allSidesColor,
      appBar: DefaultAppBar(backgroundColor: appTheme.allSidesColor),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(
              () => Text(
                controller.statusCode.value == ScreenStatusCode.change
                    ? 'change_passcode'.tr
                    : controller.statusCode.value == ScreenStatusCode.confirm
                        ? 'confirm_passcode'.tr
                        : 'enter_passcode'.tr,
