...
class EnterCodeMumberPage extends GetWidget<EnterCodeMumberController> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(
              () => Text(
                controller.statusCode.value == StatusCode.change
                    ? 'change_passcode'.tr
                    : controller.statusCode.value == StatusCode.confirm
                        ? 'confirm_passcode'.tr
                        : 'enter_passcode'.tr,
