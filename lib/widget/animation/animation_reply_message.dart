...
class AnimationReplyMessage extends StatefulWidget {
  ...
  }) : assert(swipeSensitivity >= 5 && swipeSensitivity <= 35, "swipeSensitivity value must be between 5 to 35");

  @override
  _AnimationReplyMessageState createState() => _AnimationReplyMessageState();
}

class _AnimationReplyMessageState extends State<AnimationReplyMessage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onPanUpdate: (details) {
        ...
        if (details.delta.dx < -(widget.swipeSensitivity) && widget.onLeftSwipe != null) {
